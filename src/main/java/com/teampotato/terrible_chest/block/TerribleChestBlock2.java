...
import com.teampotato.terrible_chest.tileentity.TerribleChestTileEntity2;
...
public class TerribleChestBlock2 extends Block implements IWaterLoggable {
    ...
    public void setPlacedBy(World worldIn, BlockPos pos, BlockState state, @Nullable LivingEntity placer, ItemStack stack) {
        ...
        if (tileentity instanceof TerribleChestTileEntity2 && stack.hasCustomHoverName()) ((TerribleChestTileEntity2)tileentity).setCustomName(stack.getHoverName());
    }
